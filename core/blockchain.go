...
// 添加一个区块
func (bc *Blockchain) MineBlock(miner string, transactions []*types.Transaction) *types.Block {
	...
	transactions = append([]*types.Transaction{NewRewardTx(miner, "")}, transactions...)
...
// 找到包含未花费输出的交易
func (bc *Blockchain) FindUnspentTransactions() []types.Transaction {
...
func (bc *Blockchain) FindUTXO() map[string]types.TXOutputs {
	var UTXO = make(map[string]types.TXOutputs)
